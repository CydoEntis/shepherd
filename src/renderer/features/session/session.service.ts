...
export async function patchSession(payload: { sessionId: string; name?: string; color?: string; groupId?: string | null; taskStatus?: string | null; workspaceId?: string }): Promise<SessionMeta> {
